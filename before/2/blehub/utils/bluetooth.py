...
def get_bluetooth_interfaces():
    ...
    try:
        ...
        for match in matches:
            ...
            # 추가 정보 가져오기
            name = get_interface_name(interface_id)
...
def list_bluetooth_modules():
    """블루투스 모듈 목록을 출력합니다"""
    modules = scan_bluetooth_modules()
...
def scan_bluetooth_devices_alternative():
    ...
    if test_bluetooth_tool("bluetoothctl", ["--version"]):
        try:
            # bluetoothctl 실행
