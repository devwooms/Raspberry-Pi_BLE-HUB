...
def main():
    ...
    if args.start:
        ...
        # 블루투스 검색 실행
        from blehub.utils.bluetooth import select_bluetooth_interface, select_bluetooth_device
        ...
        # 블루투스 모듈 목록 표시
        from blehub.utils.bluetooth import list_bluetooth_modules
        list_bluetooth_modules()
    elif args.select_module:
        # 블루투스 모듈 선택
        from blehub.utils.bluetooth import select_bluetooth_module
